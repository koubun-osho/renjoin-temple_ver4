...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const sanitizedDescription = finalPageData.metaDescription
    ...
    : '蓮城院公式サイトのプライバシーポリシーです。'

  return {
    title: `${sanitizedTitle} | 蓮城院`,
    description: sanitizedDescription,
    robots: 'noindex, follow', // プライバシーポリシーは検索結果に表示しない
    openGraph: {
      title: `${sanitizedTitle} | 蓮城院`,
      description: sanitizedDescription,
      type: 'website',
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="mt-1 text-sm text-green-700">
                  <p>
                    蓮城院では、皆様の個人情報の保護を重要な責務と認識し、
                    個人情報保護法に基づき適切な管理・運用を行っております。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="text-sm text-blue-800">
                ...
                <ul className="list-disc list-inside space-y-1 mb-3">
                  <li>Google Analytics（サイト利用状況の分析）</li>
                  <li>機能向上のための技術的Cookie</li>
                </ul>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <p className="text-gray-600 text-sm mb-4">
              プライバシーポリシーに関するご質問やお問い合わせは、以下よりご連絡ください。
            </p>
            <a
              href="/contact"
